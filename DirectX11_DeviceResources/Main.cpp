// g++ -o DirectX11_DR.exe ./*.cpp -ld3d11 -ldxgi -ldxguid -luuid -lkernel32 -luser32 -lcomdlg32 -ladvapi32 -lshell32 -lole32 -loleaut32 -lruntimeobject -municode -mwindows -std=c++23
//
// Main.cpp
//
